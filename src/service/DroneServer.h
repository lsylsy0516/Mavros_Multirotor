...
private:
        ...
        void takeoffOrLanding_serverCB(offboard::takeoffOrLanding::Request &req,
                                       offboard::takeoffOrLanding::Response &res);
        void flightByVel_serverCB(offboard::flightByVel::Request &req,
                                  offboard::flightByVel::Response &res);
        void flightByOffset_serverCB(offboard::flightByOffset::Request &req,
                                     offboard::flightByOffset::Response &res);
        void drop_serverCB(offboard::drop::Request &req,
